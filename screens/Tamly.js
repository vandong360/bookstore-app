...
const Tamly = ({navigation}) =>{
  ...
  function getNewsFromAPI() {
      newAPI.get('dashboard/get?category=tam-ly')
  ...
  function renderProducts(item,index) {
    ...
    <View style={styles.container}>
      ...
      name="menu-outline" size={25} color="#fff"></Ionicons>
        ...
        <Text style={{marginHorizontal:130, marginTop:10, fontSize:20, fontWeight:'bold', color:'#fff'}}>Tâm Lý</Text>
        </View>
