...
const Thieunhi = ({navigation}) =>{
  ...
  function getNewsFromAPI() {
      newAPI.get('dashboard/get?category=thieu-nhi')
  ...
  function renderProducts(item,index) {
    ...
    <View style={styles.container}>
      ...
      name="menu-outline" size={25} color="#fff"></Ionicons>
        ...
        <Text style={{marginHorizontal:130, marginTop:10, fontSize:20, fontWeight:'bold', color:'#fff'}}>Thiếu Nhi</Text>
        </View>
